...
# # for gym_id in AntBulletEnv-v0 HumanoidBulletEnv-v0 Walker2DBulletEnv-v0; do
#   for seed in {1..3}; do
...
#     # ) >& /dev/null &
#
#     # Trying with compensate_udpdate_delay
#     (sleep 0.3 && nohup python td3.py \
#       --prod-mode \
#       --wandb-project-name cleanrl.td3 \
#       --compensate-update-delay \
#       --wandb-entity dosssman \
#       --gym-id $gym_id \
#       --seed $seed \
#       --eval
...
# for gym_id in HalfCheetahBulletEnv-v0 HumanoidBulletEnv-v0; do
...
#       --seed $seed \
#       --eval \
#       --noise-type adapt-param --layer-norm
#     ) >& /dev/null &
#   done
# done
...
#         --gym-id $gym_id \
#         --seed $seed \
#         --update-delay $update_delay --compensate-update-delay\
#         --prod-mode \
#         --wandb-project-name cleanrl.td3.update_delay_exp \
#         --wandb-entity dosssman
#       ) >& /dev/null &
